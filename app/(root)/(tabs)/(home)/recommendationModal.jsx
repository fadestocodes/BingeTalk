        ...
        <View style={{ width:55, height:7, borderRadius:10, backgroundColor:Colors.mainGray, position:'absolute', top:20 }} />
            ...
            <FlatList
                ...
                renderItem = { ({item, index}) => {
                    ...
                    // const alreadySent = ownerUser.recommendationSender.some( element => element.recipientId === item.following.id && element.type === 'MOVIE' ? element.movieId === Number(DBmovieId) : element.type === 'TV' && element.tvId === Number(DBtvId)  )
