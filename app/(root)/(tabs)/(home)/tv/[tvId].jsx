...
//         setLoading(true);  
//         try {
//             const res = await GetTVById(tvId);  // Pass tvId here
//             setMovie(res);
...
//             setLoading(true);
//             try {
//                 // const res = await getTrailer({tvId});  
    
//                 // console.log('response getting trailer', res);
//                 const trailer = movie?.videos?.results.find(item => item.type === 'Trailer' && item.site === 'YouTube').key ;
//                 if (trailer) {
//                     setVideoId(trailer)
//                 }
...
//         setLoading(true);
//         try {
//             const credits = await getCredits({tvId});  
...
//     useEffect(() => {
//         if (tvId) {  // Only fetch if tvId is available
//             fetchData();
//             fetchVideos();
//             fetchCredits();
//         }
...
import TVPage from '../../../../../components/Screens/TVPage'
