...
const expressServerHaides = 'http://192.168.0.190:3000'
...
export const GetNowPlaying = async () => {
  try {
    const response = await fetch(`${expressServer}/tmdb/now-playing`);
...
export const GetMovieById = async (movieId) => {
  try {
    const response = await fetch (`${expressServer}/tmdb/movie/id?movieId=${movieId}`);
    const data = await response.json();
...
export const GetTVById = async (tvId) => {
  try {
    const response = await fetch (`${expressServer}/tmdb/tv/id?tvId=${tvId}`);
    const data = await response.json();
    // console.log('data is ', data);
    return (data);
  } catch (err) {
...
export const getTrailer = async ({movieId, showId}) => {
  ...
  try {
    if (movieId) {
      const response = await fetch(`${expressServer}/tmdb/id/videos?movieId=${movieId}`);
      const data = await response.json();
      return data;
    } else if (showId) {
      const response = await fetch(`${expressServer}/tmdb/id/videos?showId=${showId}`);
      const data = await response.json();
      return data;
    }
  } catch(err) {
...
export const getCredits = async  ({movieId, showId}) => {
  try {
    if (movieId) {
      const response = await fetch (`${expressServer}/tmdb/id/credits?movieId=${movieId}`)
      const data = await response.json();
      return data;
    } else if (showId) {
      const response = await fetch (`${expressServer}/tmdb/id/credits?movieId=${movieId}`)
...
export const getPerson = async (castId) => {
  try {
    const response = await fetch(`${expressServer}/tmdb/person?id=${castId}`);
    const data = await response.json();
    return data;
  } catch (err) {
...
export const searchAll = async (query) => {
  ...
  try {
    ...
    const response = await fetch (`${expressServer}/tmdb/search/all?query=${encodedQuery}`);
    const data = await response.json();
    return data
  } catch (err) {
    console.log(err)
...
export const getTrending = async () => {
  try {
    const response = await fetch(`${expressServer}/tmdb/trending/all`);
    const data = await response.json();
    return data
  } catch (err) {
...
export const getUpcoming = async () => {
  try {
    const response = await fetch(`${expressServer}/tmdb/movie/upcoming`);
    const data = await response.json();
    return data
  } catch (err) {
    console.log('Error fetching trending', err)
...
export const getTrendingPeople = async () => {
  try {
    const response = await fetch(`${expressServer}/tmdb/trending/people`);
    const data = await response.json();
    return data
  } catch (err) {
...
export const getDiscoverTV = async () => {
  try {
    const response = await fetch(`${expressServer}/tmdb/discover/tv`);
    const data = await response.json();
    return data
  } catch (err) {
    console.log('Error fetching trending people', err)
...
export const uploadToS3 = async ( fileUri, fileName, fileType ) => {
  ...
  try {
    const response = await fetch (`${expressServer}/aws/s3-upload`, {
      method : 'POST',
      headers : {
